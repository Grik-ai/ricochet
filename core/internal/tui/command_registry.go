...
var slashCommandRegistry = []SlashCommandSpec{
	...
	{Name: "/logout", Usage: "/logout", Description: "Remove the saved Grik Account token.", Category: "Account", Tier: SlashCommandAdvanced, Source: "builtin", Implemented: true},
	{Name: "/account", Usage: "/account [billing|models]", Description: "Show Grik Account billing and hosted Ricochet models.", Category: "Account", Tier: SlashCommandPrimary, Source: "builtin", Implemented: true},
	{Name: "/billing", Usage: "/billing", Description: "Show Grik Account credits and entitlements.", Category: "Account", Tier: SlashCommandAdvanced, Source: "builtin", Implemented: true},
