                    ...
                    sessions: [
                        {
                            ...
                            workspaceDir: '/workspace/polybot',
    ...
    const events: Array<[number, DevMessage]> = [
        ...
        [900, {
            ...
            payload: {
                ...
                edits: [
                    {
                        filePath: '/workspace/polybot/src/error.rs',
        ...
        workers: [
            {
                ...
                path: '/workspace/ricochet/.ricochet/batch/core',
            ...
            },
            {
                ...
                path: '/workspace/ricochet/.ricochet/batch/ui',
            ...
            },
            {
                ...
                path: '/workspace/ricochet/.ricochet/batch/tests',
...
function createDevBatchRunFromRequest(payload: any): DevBatchRun {
    ...
    return {
        ...
        workers: workers.map((title: string, index: number) => ({
            ...
            path: `/workspace/ricochet/.ricochet/batch/${runId}-w${index + 1}`,
